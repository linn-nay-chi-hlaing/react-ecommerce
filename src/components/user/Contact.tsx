    ...
    <UserLayout>
      <div className="contact-section">
        <div className="contactMain">
          <div className="contactHeader-box">
            <h2>🙋‍♀️Contact Amara</h2>
            <p>Get in touch and let us know how we can help.</p>
            <p>
              You have access to Priority Support - our team will reply to your
              question before everyone else’s! We’ll be in touch very soon
            </p>
          </div>
          ...
          <div className="contact-box">
            ...
            <form>
              <div className="contactForm">
                ...
                <br />
                <input className="contact-input" type="text" name="inquiry" />
              </div>
              ...
              <div className="contactForm">
                ...
                <div className="contact-field">
                  {/* <input className="contact-input" type="text" name="name" value="{{ auth()->user()->name }}" readOnly />
              ...
              <div className="contactForm">
                ...
                <br />
                <div className="contact-field">
                  {/* <input class="contact-input" type="text" name="email" value="{{ auth()->user()->email }}" readonly>

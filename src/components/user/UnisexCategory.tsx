...
export default function MenCategory() {
  ...
  const filteredProducts = unisexProducts.filter((product) => {
  ...
  return (
    <UserLayout>
      <section
        ...
        style={{ backgroundImage: `url("public/images/unisex.jpg")` }}
      >
        <div className="overlay"></div>
        <div className="perfume-content">
          <h1>Unisex Perfume</h1>
          <p>
            Unisex perfume, also known as gender-neutral fragrance, is a
            balanced blend of essential oils, aromatic compounds, and fixatives
            designed to suit all genders. It often features versatile notes such
            as citrus, woody, green, or musky accords that appeal universally,
            offering a fresh and inclusive scent experience.
          </p>
        </div>
      </section>
            ...
            <div className="categoryFilter-options">
              ...
              <Link to="/women-products">
                <div className="unisex">
                  <span>Women</span>
                  <div className="totalNum">
                    <span>{womenProducts.length}</span>
                  </div>
                </div>
              </Link>
            </div>

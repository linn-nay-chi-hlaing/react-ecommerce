  ...
  return (
    <UserLayout>
      <section
        ...
        style={{ backgroundImage: `url("public/images/men-perfume.jpg")` }}
      >
        <div className="overlay"></div>
        <div className="perfume-content">
          <h1>Mens’ Perfume</h1>
          <p>
            Men's perfume, often called cologne or eau de toilette, is a
            fragrant blend of essential oils, aroma compounds, and fixatives
            designed to enhance a man's personal scent. It typically features
            masculine notes such as woody, spicy, leathery, or fresh citrus
            accords.
          </p>
        </div>
      </section>
